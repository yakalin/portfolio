...
export class ProjectsService {
  projects: Project[] = [
    ...
    {id: 2, name: 'Sample Project 3', summary: 'This is another project', description: 'This is a website I made to showcase my projects and skills.', link: '', tags: [Tag.TYPESCRIPT, Tag.PYTHON, Tag.FASTAPI], img: ['../../assets/img/portfolio.png']},
    ...
    {id: 4, name: 'Sample Project 3', summary: 'This is another project', description: 'This is a website I made to showcase my projects and skills.', link: '', tags: [Tag.HTML, Tag.PYTHON, Tag.TYPESCRIPT], img: ['../../assets/img/portfolio.png']},
